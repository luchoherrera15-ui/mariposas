-- ============================================================================
--  Mariposas — pedidos, envíos y tracking de demostración
--
--  IMPORTANTE: correlo al final, y SOLO después de haberte registrado en el
--  sitio (http://localhost:3000/entrar).
--
--  >>> CAMBIÁ el correo de la línea de abajo por el tuyo. <<<
-- ============================================================================
